...
namespace Provisions_Trader;

// This record holds the various properties for your mod
public record ModMetadata : AbstractModMetadata
{
    public override string ModGuid { get; init; } = "com.stroopflavor.provisions_trader";
    public override string Name { get; init; } = "StroopFlavor-Provisions_Trader";
    public override string Author { get; init; } = "StroopFlavor";
    public override List<string>? Contributors { get; init; } = ["StroopFlavor"];
    public override SemanticVersioning.Version Version { get; init; } = new("1.0.0");
    public override SemanticVersioning.Range SptVersion { get; init; } = new("~4.0.1");
    public override List<string>? Incompatibilities { get; init; } = [""];
    public override Dictionary<string, SemanticVersioning.Range>? ModDependencies { get; init; }
    public override string? Url { get; init; } = "https://github.com/StroopFlavor/Provisions_Trader";
    ...
    : IOnLoad
{
    ...
    public Task OnLoad()
    {
        ...
        var traderImagePath = Path.Combine(pathToMod, "data/Provisions_Trader.jpg");
        ...
        addCustomTraderHelper.AddTraderToLocales(traderBase, "Mr. Holodilnick", "A Thermal Bag with all the foods and drinks. There is also a small coin purse that says 'Help yourself but give what you can'. You feel compelled to pay the Bag.");
